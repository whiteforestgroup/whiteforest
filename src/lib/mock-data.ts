...
export const statusColumns: BookingStatus[] = [
  "new",
  "scheduled",
  "in_progress",
  "completed",
...
export const messages: Message[] = [
  ...
  },
  {
    ...
    customerName: "Marcus Lee",
    phone: "(555) 987-6543",
    preview: "Reminder: your detail is scheduled for tomorrow at 2pm.",
    timestamp: "Yesterday",
    unread: false,
    direction: "outbound",
  },
  {
    ...
    customerName: "Aisha Khan",
    phone: "(555) 333-7788",
    preview: "Can we push to Thursday instead?",
    timestamp: "Yesterday",
    unread: true,
    direction: "inbound",
  },
  {
    ...
    customerName: "Rosa Fernandez",
    phone: "(555) 555-0134",
    preview: "Thanks for booking! We'll text a reminder 24h before.",
    timestamp: "Mon",
    unread: false,
    direction: "outbound",
  },
  {
    ...
    customerName: "Sam Whitfield",
    phone: "(555) 444-9922",
    preview: "Great service as always 👍",
    timestamp: "Aug 17",
    unread: false,
    direction: "inbound",
  },
...
export const dashboardActivity = [
  ...
  {
    id: "a_4",
    text: "Priya Patel's Essential Wash completed",
    time: "Yesterday",
  },
];
