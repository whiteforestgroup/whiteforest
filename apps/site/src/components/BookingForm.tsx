...
export function BookingForm() {
    ...
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-2 text-slate-600">
          Thanks for booking with {tenant.businessName}. We&apos;ll text or call you at the
          number you provided to confirm a time.
        </p>
        <button
          type="button"
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700" htmlFor="packageId">
          Package
        </label>
        <select
          id="packageId"
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700" htmlFor="preferredDate">
          Preferred date
        </label>
        <input
          id="preferredDate"
      ...
      <button
        ...
        className="sm:col-span-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-sm transition-opacity disabled:opacity-60"
